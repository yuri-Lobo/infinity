...
@Component({
  selector: "app-modals",
  templateUrl: "./novoAndamento.component.html",
  styleUrls: ["./novoCard.component.scss"],
})
export class NovoAndamentoComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if (this.id != undefined) {
      this.editando == true;
      this.titulo = "Editando Andamento";
      this.dados = this.dadosEditando;
      this.dados.dataFinal = this.dadosEditando.dataFinal.substring(0, 10);
      this.dados.dataInicial = this.dadosEditando.dataInicial.substring(0, 10);
    ...
    } else this.titulo = "Novo Andamento";
  }
