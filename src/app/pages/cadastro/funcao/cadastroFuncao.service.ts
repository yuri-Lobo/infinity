...
import { Funcao, SearchResult } from "src/app/core/models/funcao.models";
...
/**
 * Sort the table data
 * @param tabless Funcao field value
...
/**
 * Funcao Data Match with Search input
 * @param tables Funcao field value fetch
 * @param term Search the value
 */
function matches(tables: Funcao, term: string, pipe: PipeTransform) {
  return (
...
export class CadastroFuncaoService {
  // tslint:disable-next-line: variable-name 
  private _loading$ = new BehaviorSubject<boolean>(true);
  // tslint:disable-next-line: variable-name
  private _search$ = new Subject<void>();
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<Funcao[]>([]);
  // tslint:disable-next-line: variable-name
  ...
  private _search(): Observable<SearchResult> {
    ...
    // 1. sort
    let tables = sort(dadosCadstroFuncao, sortColumn, sortDirection);
